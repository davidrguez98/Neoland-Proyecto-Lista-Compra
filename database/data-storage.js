export const defaultBBDD = [
  {
    ...
    stock: { "250": 20, "500": 2, "1000": 1 },
    price: { "250": 15.7, "500": 26.0, "1000": 49.1 }
  },
  {
    img: "../assets/coffee/2.webp",
    name: "Tolima",
  ...
  },
  {
    ...
    stock: { "250": 20, "500": 4, "1000": 6 },
    price: { "250": 15.4, "500": 26.4, "1000": 46.7 }
  },
  {
    img: "../assets/coffee/10.webp",
    name: "Giku Hill",
    description: "Desde Burundi, Giku Hill crece a 1700 metros en tierras ricas cerca del Bosque Kibira. Aunque las comunidades enfrentan desafíos de infraestructura, producen uno de los cafés más expresivos del país. Su perfil destaca por su cuerpo limpio y matices brillantes. Un verdadero ejemplo de calidad en condiciones difíciles.",
    stock: { "250": 16, "500": 5, "1000": 1 },
    price: { "250": 17.0, "500": 29.8, "1000": 56.4 }
  },
  {
    img: "../assets/coffee/11.webp",
    name: "Bukonzo Anaerobic",
    description: "Desde Kasese, Uganda, Bukonzo Ana es una joya fermentada en ambiente anaeróbico. Forma parte de una serie que refleja el terroir de los Rwenzori. Cada grano ofrece una nueva dimensión en complejidad, con notas afrutadas y ácidas. Es un café que desafía expectativas y ofrece una experiencia sensorial extraordinaria.",
    stock: { "250": 22, "500": 8, "1000": 10 },
    price: { "250": 16.7, "500": 29.8, "1000": 53.3 }
  },
  {
    img: "../assets/coffee/12.webp",
    name: "Los Rodriguez",
    description: "Desde Caranavi, Bolivia, Los Rodriguez es producido entre 1570 y 1650 metros por una familia dedicada a la excelencia. Vinculado al programa Sol de la Mañana, este café simboliza progreso y calidad. Su perfil es balanceado, con acidez delicada y cuerpo redondo, convirtiéndolo en un favorito entre los amantes del buen café.",
    stock: { "250": 23, "500": 13, "1000": 6 },
    price: { "250": 15.2, "500": 25.2, "1000": 50.8 }
  },
  {
    img: "../assets/coffee/13.webp",
    name: "Cajamarca",
    description: "En el norte de Perú, Cajamarca se eleva como una región cafetera por excelencia. Gracias a su clima tropical, suelos volcánicos y altitudes privilegiadas, este café de temporada destaca por su perfil limpio y cuerpo medio. Representa lo mejor de la caficultura peruana, con una taza vibrante y estructurada.",
    stock: { "250": 5, "500": 15, "1000": 1 },
    price: { "250": 16.3, "500": 26.6, "1000": 53.3 }
  },
  {
    img: "../assets/coffee/14.webp",
    name: "Wanja Kersa",
    description: "Desde Gera, Etiopía, en la estación Atoma a 2000 metros, llega Wanja Kersa. Es el segundo sitio gestionado por Mike Mamo y refleja el potencial etíope con gran precisión. El café producido aquí es refinado, con notas florales y acidez cítrica, siendo una expresión auténtica de su origen.",
    stock: { "250": 13, "500": 2, "1000": 7 },
    price: { "250": 15.1, "500": 24.8, "1000": 51.0 }
  }
]